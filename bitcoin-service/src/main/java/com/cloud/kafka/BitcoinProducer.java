...
public class BitcoinProducer {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(BitcoinProducer.class);
    ...
    public BitcoinProducer(KafkaTemplate<String, String> kafkaTemplate, RestTemplate restTemplate,
